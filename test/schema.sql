CREATE TABLE spaces (
  ...
  settings JSON,
  verified INT NOT NULL DEFAULT O,
  deleted INT NOT NULL DEFAULT O,
  flagged INT NOT NULL DEFAULT O,
  hibernated INT NOT NULL DEFAULT O,
  turbo INT NOT NULL DEFAULT O,
  turbo_expiration BIGINT NOT NULL DEFAULT O,
  proposal_count INT NOT NULL DEFAULT O,
  vote_count INT NOT NULL DEFAULT O,
  follower_count INT NOT NULL DEFAULT O,
...
CREATE TABLE leaderboard (
  ...
  space VARCHAR(64) NOT NULL,
  vote_count SMALLINT UNSIGNED NOT NULL DEFAULT O,
  proposal_count SMALLINT UNSIGNED NOT NULL DEFAULT O,
  last_vote BIGINT,
...
CREATE TABLE networks (
  ...
  testnet TINYINT UNSIGNED NOT NULL DEFAULT O,
  premium TINYINT UNSIGNED NOT NULL DEFAULT O,
  PRIMARY KEY (id),
